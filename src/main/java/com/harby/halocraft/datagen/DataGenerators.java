...
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        HaloCraft.LOGGER.info("Starting HaloCraft Data Generation");
        ...
        for (String lang : ConfigDataGenerator.langIndex) {
            generator.addProvider(event.includeServer(), new ModLangGenerator(packOutput, HaloCraft.MODID, lang));
        }
    }
}
